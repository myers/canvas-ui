...
// process.cwd() is the package directory (e.g., packages/core)
const workspaceRoot = path.resolve(process.cwd(), '../..')
const isInWorkspace = existsSync(path.join(workspaceRoot, 'pnpm-workspace.yaml'))
