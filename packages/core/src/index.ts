...
export function createElement(type: 'Canvas', canvas?: HTMLCanvasElement | OffscreenCanvas, platformAdapter?: IPlatformAdapter): RenderCanvas
...
export function createElement(type: ElementType, canvas?: any, platformAdapter?: any): RenderObject {
  if (type === 'View') {
    ...
    return new RenderCanvas(canvas, platformAdapter)
  } else if (type === 'Rect') {
